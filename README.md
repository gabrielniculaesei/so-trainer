...
| `data/data_mappa.js`, `js/mappa.js` | Mappa mentale del corso: 127 concetti in un albero navigabile (radice → 4 capitoli → sezioni → concetti), ognuno con spiegazione, nota “all'esame” e collegamenti a quiz, flashcard e simulazione |
...
* **Mappa**: la mappa mentale della teoria. Apri i rami, clicca un concetto e leggi la spiegazione nel pannello, con la nota su cosa viene chiesto all'esame e i collegamenti al quiz, alle flashcard e alla simulazione dell'argomento. Cerca un concetto per nome, segna come “ripassato” ciò che sai già e usa la barra di avanzamento per vedere quanto manca: è il ripasso d'insieme da fare nei giorni prima dell'esame.
